...
class db
{
	...
	{ // opens the db connection. Specify different databases for local and live server and it will automatically select the correct one
	...
	public static function deleteRecord($table, $pk)
	{ // Gets the Id of row to be deleted and table name
		$db = db::open();
	...
	public static function deleteRecord1($table, $pk)
	{ // Gets the Id of row to be deleted and table name
		$db = db::open();
	...
	public static function deleteRecord2($table, $pk)
	{ // Gets the Id of row to be deleted and table name
		$db = db::open();
	...
	public static function deleteRecord4($table, $pk)
	{ // Gets the Id of row to be deleted and table name
		$db = db::open();
	...
	public static function deleteRecord5($table, $pk, $pk1)
	{ // Gets the Id of row to be deleted and table name
		$db = db::open();
	...
	{ // Gets a formatted query to insert a row and returns the ID of last added record
		$db = db::open();
		$db->query($query);
		$result = $db->insert_id;
		db::close($db);
