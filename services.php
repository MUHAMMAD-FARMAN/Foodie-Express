				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Free Supports</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Fast Serve On Table</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Fresh Healthy Food</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Quick Delivery</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							<div class="icon-bx">
								<div class="icon-cell">
									<i class="flaticon-token"></i>
								</div>
							</div>
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Order Tokan</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Table Service</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Awesome Team</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Discount Voucher</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
